...
def set_up_config(_DIR = None):
    ...
    DATA_SOURCE = os.path.join('./../data/', DIR_LOC)
...
def HSCode_cleanup_aux(val):
    ...
    val = val.replace('.','')
    val = str(val[:6])
    if val[:2] == '44': return val
    _list =['9401','9403','9201','9614','9202','9302', '9304', '0305', '8211', '6602','8201','9207','9504', '9205', '9206', '9209''9202']
    if val[:4] in _list: return val 
    return val
